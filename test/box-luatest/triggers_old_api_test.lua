...
g.before_all(function()
    ...
    g.server:exec(function()
        ...
        -- of the associated event in the trigger registry. The second argument
        -- is optional.
...
g.test_old_api = function()
    g.server:exec(function()
        ...
        local function check_trigger(old_api_trigger)
            ...
            -- Invalid arguments
            t.assert_error(old_api_trigger, nil, nil, {1, 2})
            t.assert_error(old_api_trigger, nil, nil, h1)
            t.assert_error(old_api_trigger, 'abc')
            t.assert_error(old_api_trigger, nil, 'abc')
            t.assert_error(old_api_trigger, 'abc', 'abc')
            t.assert_error(old_api_trigger, 'abc', nil, 'name')
            ...
            t.assert_equals(old_api_trigger(), {h3, h4, h1})
            ...
            t.assert_equals(old_api_trigger(nil, h1), nil)
            t.assert_equals(old_api_trigger(), {})

            -- Name argument
            t.assert_equals(old_api_trigger(h1, nil, 't1'), h1)
            t.assert_equals(old_api_trigger(), {h1})
            -- Check if 2nd argument will be ignored
...
g.test_key_value_args = function()
    g.server:exec(function()
        ...
        local function check_trigger(old_api_trigger)
            ...
            -- Invalid arguments
            t.assert_error(old_api_trigger, {func = h1, name = 'trg'}, h1)
            t.assert_error(old_api_trigger, {func = h1, name = 'trg'}, 'abc')
            t.assert_error(old_api_trigger, {func = 'str', name = 'trg'})
            t.assert_error(old_api_trigger, {func = h1})
            t.assert_error(old_api_trigger, {func = h1, name = box.NULL})
            ...
            t.assert_equals(old_api_trigger{name = 'h3'}, nil)
            t.assert_equals(old_api_trigger(), {h1})
